...
A2_tilde =  (1/pi)*dpnorm_ratio.*XR2_ratio; %(1i*mu/2)*dpnorm_ratio.*XR_ratio.*besselh(1,mu*Rin);
A_tilde(i,:) = pi/N1*A2_tilde.*dtau;

B2_tilde = -(1/pi)*dp2norm.*log(Rin);%(1i/2)*besselh(0,mu*Rin).*dp2norm; % make this a tp and then sum and scale
