...
function [len,evs,eden,evecs,A,B] = stek_lap_corners(curve_name,curve_params,N,M,p,al,bt,len1,tol,Hom,rho_wt,eigsk,neumann_pieces,dirichlet_pieces)
...
[A_tildes{pp,pp},B_tildes{pp,pp}] =...
    laplayer_pots2(Taus{pp},Taus1{pp},Ts{pp},Ts1{pp},dTaus{pp},Xtau,Xt,Ytau,Yt,dXtau,dXt,dYtau,dYt,d2Xt,d2Yt);
...
[A_tildes{pp,pp2},B_tildes{pp,pp2}] = ...
    laptalking_pots(dTaus{pp2},x_in,dXtau,dYtau,x_out,dXt_out,dYt_out); 
